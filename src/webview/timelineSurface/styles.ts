...
.dvqr-timeline-audit-button.is-active {
  background: rgba(251, 191, 36, 0.16);
}

.dvqr-timeline-audit-context {
  margin-top: 10px;
  padding: 12px;
...
.dvqr-timeline-audit-context[hidden] {
  display: none;
}
...
.dvqr-timeline-audit-context,
.dvqr-timeline-audit-context [data-audit-result],
.dvqr-timeline-audit-context .dvqr-audit-result {
  min-width: 0;
  max-width: 100%;
}

.dvqr-timeline-audit-context .dvqr-audit-result,
.dvqr-timeline-audit-context .dvqr-audit-result p,
.dvqr-timeline-audit-context .dvqr-audit-result dd,
.dvqr-timeline-audit-context .dvqr-audit-result code {
  overflow-wrap: anywhere;
  word-break: break-word;
  white-space: normal;
}

.dvqr-audit-error-summary {
  display: grid;
...
.dvqr-audit-error-summary dt {
  color: var(--dvqr-muted);
  font-size: 12px;
}

.dvqr-audit-error-summary dd {
  margin: 0;
  min-width: 0;
}

.dvqr-audit-technical-details {
  min-width: 0;
  margin-top: 10px;
}

.dvqr-audit-technical-details pre {
  margin: 8px 0 0;
  max-width: 100%;
  overflow: auto;
  padding: 10px;
